...
Цель — сопоставлять изменения активности конкретных новостных тем с экономическими и финансовыми показателями. Планируемый сценарий: выбрать показатель и период, увидеть изменение доли тем относительно предыдущего периода и открыть статьи, стоящие за изменением.
